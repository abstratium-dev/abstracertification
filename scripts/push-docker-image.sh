...
docker push ghcr.io/abstratium-dev/abstracertification:$VERSION
docker push ghcr.io/abstratium-dev/abstracertification:latest
...
echo "  - ghcr.io/abstratium-dev/abstracertification:$VERSION"
echo "  - ghcr.io/abstratium-dev/abstracertification:latest"
