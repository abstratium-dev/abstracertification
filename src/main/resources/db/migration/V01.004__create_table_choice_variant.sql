...
CREATE TABLE T_choice_variant (
    ...
    CONSTRAINT FK_choice_variant_page_entry FOREIGN KEY (page_entry_id) REFERENCES T_page_entry(id),
    CONSTRAINT FK_choice_variant_step FOREIGN KEY (step_id) REFERENCES T_certification_step(id)
);
