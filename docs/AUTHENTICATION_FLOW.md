...
sequenceDiagram
    ...
    OIDC->>Auth: POST /oauth2/token<br/>grant_type=authorization_code<br/>&code=[auth_code]<br/>&redirect_uri=http://localhost:8085/oauth/callback<br/>&code_verifier=[verifier]<br/>Authorization: Basic [client_id:secret]
...
quarkus.http.cors.origins=http://localhost:4205,http://localhost:8085
